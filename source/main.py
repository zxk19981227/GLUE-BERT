...
def train(epoch, rate, model_name, hidden_num, label_number, reader, train_path, eval_path, loss_function,
    ...
    model = model.cuda()
    model.train()
    optimizer = torch.optim.Adam(rate)
    ...
    for i in range(epoch):
        ...
        loss_it = []
        for num, (label, mask, seg, token) in train_loader:
...
def main(argvs):
    ...
    task_function = {"WNLI": WNLI_reader, "SST-2": SST_reader, "RTE": RTE_reader, "CoLA": CoLA_reader,
                     ...
                     "SST-B": SSTB_reader,"SNLI":SNLI_reader}
    accuracy_function = {"WNLI": Eval_acc, "SST-2": Eval_acc, "RTE": Eval_acc, "CoLA": Eval_acc, "MNLI": Eval_acc,
                         "MRPC": Eval_F1, "QNLI": Eval_acc, "QQP": Eval_acc, "SST-B": Eval_MC,"SNLI":Eval_acc}
    number_diction = {"SST-2": 2, "RTE": 2, "CoLA": 2, "MNLI": 3, "MRPC": 2, "QNLI": 3, "QQP": 2, "WNLI": 2,"SNLI":3, "SST-B": 1}
    loss_dic = {"SST-2": "crossEntropyLoss", "RTE": "crossEntropyLoss", "CoLA": "crossEntropyLoss",
                ...
                "QQP": "crossEntropyLoss", "WNLI": "crossEntropyLoss", "SST-B": "MSE","SNLI":"crossEntropyLoss"}
